          ...
          <div className="bg-stone-900 border-2 border-red-500 rounded-2xl p-6 max-w-3xl w-full shadow-2xl flex flex-col max-h-[85vh]">
            ...
            <div className="flex-1 overflow-y-auto space-y-4 p-2">
              ...
              <div className="border-t border-stone-800 pt-4">
                ...
                <div className="grid grid-cols-4 gap-4">
                  {opponentProperties.filter((c: any) => getCardColor(c) !== harryProtectedColor).map((card: any) => (
                  ...
                  {opponentProperties.filter((c: any) => getCardColor(c) !== harryProtectedColor).length === 0 && <span className="text-stone-500 italic text-xs col-span-4">No eligible items played</span>}
                </div>
              </div>
            </div>
          </div>
